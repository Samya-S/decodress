    ...
    <div className="flex min-h-[52vh] flex-col justify-center px-6 py-12 lg:px-8">
      ...
      {token && <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
        <form onSubmit={resetPassword} className="space-y-6" action="#" method="POST">
          ...
          <div>
            <button disabled={!password || !confirmPassword} type="submit" className="flex w-full justify-center rounded-md bg-pink-600 disabled:bg-pink-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-pink-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-600">Reset password</button>
          </div>
        </form>
      </div>}
